...
- Notification settings include **validation** to ensure correct input values.
...
## 🆕 Aug 2024 – Log in with Gmail

**Type:** New Feature  

**Details:**  
- Launch of **Log in with Gmail**, allowing users to quickly and securely access their accounts using Gmail credentials.
...
**How to Use:**  
1. Click the **"Log in with Gmail"** button on the sign-in page
...
## 🆕 Jun 2024 – Now Processing PDFs on GPU System 🥳
