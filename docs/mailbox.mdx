...
| ---------- | ---------------------------: | --------------- | -------------- |
| Pro        | Max 3 attachments per email  | Parallel        | 90 days        |
| Bussiness  | Max 6 attachments per email  | Parallel        | 365 days       |
...
1. Your account gets a **unique email address**.
    ![Mailbox](/images/mailboxdashboard.png)
